  ...
  describe 'EBS-volume based flow' do
    ...
    context 'heavy stemcell' do
      ...
      it 'should create a stemcell' do
        ...
        expect(cloud).to receive(:create_disk).with(2048, {'encrypted' => nil, 'kms_key_arn' => nil}, 'i-xxxxxxxx').and_return('vol-xxxxxxxx')
      ...
      context 'when encrypted flag is set to true and kms_key_arn is provided' do
        let(:stemcell_properties) do
          {
              'root_device_name' => '/dev/sda1',
              'architecture' => 'x86_64',
