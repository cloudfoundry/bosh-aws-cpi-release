...
time bosh2 -n run-errand -d e2e-test iam-instance-profile-test & \
  bosh2 -n run-errand -d e2e-test raw-ephemeral-disk-test & \
  bosh2 -n run-errand -d e2e-test elb-registration-test & \
  bosh2 -n run-errand -d e2e-test heavy-stemcell-test & \
  bosh2 -n run-errand -d e2e-test encrypted-heavy-stemcell-test
