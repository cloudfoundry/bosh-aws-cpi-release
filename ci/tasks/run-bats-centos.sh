...
source terraform-centos-exports/terraform-centos-exports-${terraform_statefile_semver}.sh

export BAT_DIRECTOR=$CENTOS_DIRECTOR
export BAT_DNS_HOST=$CENTOS_DIRECTOR
export BAT_INFRASTRUCTURE=aws
export BAT_NETWORKING=manual
export BAT_VIP=$CENTOS_VIP
export BAT_SUBNET_ID=$CENTOS_SUBNET_ID
export BAT_SECURITY_GROUP_NAME=$CENTOS_SECURITY_GROUP_NAME
